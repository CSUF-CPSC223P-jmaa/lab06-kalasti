...
def balanced(m):
    ...
    # return True if planet(m) else (length(left(m)) * total_weight(end(left(m))) == length(right(m)) * total_weight(end(right(m))) and balanced(end(left(m))) and balanced(end(right(m))) )
